    ...
    return types.SimpleNamespace(
        **{
            ...
            **mc.model_dump(include=set(_MC_NAMESPACE_FIELDS)),
            ...
            # Depth extras.  They are present on current TrainConfig, while
            # getattr keeps older serialized configs compatible.
            "depth_loss_coef": getattr(tc, "depth_loss_coef", 5.0),
            "pinhole_loss_coef": getattr(tc, "pinhole_loss_coef", 1.0),
            "focal_length_px": getattr(tc, "focal_length_px", None),
            "ball_diameter_m": getattr(tc, "ball_diameter_m", 0.22),
            "ball_class_ids": getattr(tc, "ball_class_ids", []),
            "curriculum_phase1_epochs": getattr(tc, "curriculum_phase1_epochs", 10),
            "curriculum_phase2_epochs": getattr(tc, "curriculum_phase2_epochs", 40),
